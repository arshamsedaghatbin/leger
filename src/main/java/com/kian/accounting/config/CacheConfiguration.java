...
import com.kian.common.config.MetricsConfiguration;
import com.kian.common.config.WebConfigurer;
...
public class CacheConfiguration {
	...
	private @Value("${spring.jpa.properties.hibernate.cache.hazelcast.instance_name}")
	String instanceName;
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
    	log.info("${spring.jpa.properties.hibernate.cache.hazelcast.instance_name} = {} ", instanceName);
        ...
        config.getMapConfigs().put("com.kian.digital.domain.*", initializeDomainMapConfig(jHipsterProperties));
